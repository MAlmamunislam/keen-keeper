  ...
  return (
    <div>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mx-2 ">
        <div className="border p-8  bg-white border-gray-50   rounded-2xl shadow-md flex flex-col items-center justify-center gap-2 hover:shadow-lg transition-shadow hover:border-gray-200">
          <h2 className="text-[32px] font-semibold text-[#1F2937] ">10</h2>
